  ...
  const projects = [
    {
      ...
      description: 'High-performance shopping experience with real-time inventory.',
      href: '/portfolio'
    },
    {
      id: 2,
      ...
      description: 'User-centric design that drives engagement and conversions.',
      href: '/portfolio'
    },
    {
      id: 3,
    ...
    },
    {
      ...
      description: 'Intuitive analytics platform for data-driven decisions.',
      href: '/portfolio'
    }
  ]
          ...
          {projects.map((project, idx) => (
            ...
            >
              <Link href={project.href} className="block h-full">
                <div className="group relative bg-gradient-to-br from-gray-900/50 to-black border border-gray-800/50 rounded-xl sm:rounded-2xl p-6 sm:p-7 md:p-8 lg:p-10 h-[300px] sm:h-[320px] md:h-[340px] lg:h-[380px] flex flex-col transition-all duration-500 hover:border-purple-500/50 hover:bg-gradient-to-br hover:from-gray-900/80 hover:to-black hover:shadow-2xl hover:shadow-purple-500/10 cursor-pointer overflow-hidden">
