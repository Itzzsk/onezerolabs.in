...
const HeroWave = () => {
  ...
  useEffect(() => {
    ...
    const SCALE = 2; // Optimization: Render at 1/2 resolution and upscale
    ...
    // Precompute Sine/Cosine tables for performance optimization
    ...
    const render = () => {
      ...
      // Draw the low-res buffer to the main canvas (upscaling)
      if (SCALE > 1) {
